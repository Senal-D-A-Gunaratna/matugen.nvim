...
A Material You colorscheme for Neovim. It reads colors generated by
[matugen](https://github.com/InioX/matugen) and maps them straight to Neovim
highlight groups through a semantic palette — no recomputation, no guesswork
