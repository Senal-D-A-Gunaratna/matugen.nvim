return function(c, hl)
	...
	hl("Constant", { fg = c.primary_fixed_dim })
	hl("String", { fg = c.tertiary_fixed_dim, italic = true })
	hl("Character", { fg = c.tertiary })
	hl("Number", { fg = c.secondary_fixed_dim })
	hl("Boolean", { fg = c.primary, bold = true })
	hl("Float", { fg = c.secondary_fixed_dim })
	...
	hl("Operator", { fg = c.inverse_primary })
	...
	hl("Type", { fg = c.secondary_fixed_dim })
	hl("StorageClass", { fg = c.primary })
	hl("Structure", { fg = c.secondary_fixed_dim })
	hl("Typedef", { fg = c.secondary_fixed_dim })
	...
	hl("@boolean", { fg = c.primary, bold = true })
	hl("@number", { fg = c.secondary_fixed_dim })
	hl("@number.float", { fg = c.secondary_fixed_dim })
	...
	hl("@constant", { fg = c.primary_fixed_dim, bold = true })
	...
	hl("@keyword.operator", { fg = c.inverse_primary })
	hl("@keyword.import", { fg = c.secondary })
	hl("@keyword.type", { fg = c.secondary_fixed_dim })
	...
	hl("@keyword.conditional.ternary", { fg = c.inverse_primary })
	hl("@keyword.directive", { fg = c.secondary })
	hl("@keyword.directive.define", { fg = c.secondary })

	hl("@type", { fg = c.secondary_fixed_dim })
	hl("@type.builtin", { fg = c.secondary_fixed_dim, italic = true })
	hl("@type.definition", { fg = c.secondary_fixed_dim })
	...
	hl("@punctuation.special", { fg = c.inverse_primary })
