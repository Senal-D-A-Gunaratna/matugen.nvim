return function(c, hl)
	hl("@lsp.type.class", { fg = c.secondary_fixed_dim })
	hl("@lsp.type.comment", { fg = c.outline, italic = true })
	hl("@lsp.type.decorator", { fg = c.secondary })
	hl("@lsp.type.enum", { fg = c.secondary_fixed_dim })
	hl("@lsp.type.enumMember", { fg = c.primary_fixed_dim, bold = true })
	...
	hl("@lsp.type.number", { fg = c.secondary_fixed_dim })
	hl("@lsp.type.operator", { fg = c.inverse_primary })
	hl("@lsp.type.parameter", { fg = c.on_surface_variant })
	hl("@lsp.type.property", { fg = c.tertiary })
	hl("@lsp.type.regexp", { fg = c.tertiary })
	hl("@lsp.type.string", { fg = c.tertiary_fixed_dim, italic = true })
	hl("@lsp.type.struct", { fg = c.secondary_fixed_dim })
	hl("@lsp.type.type", { fg = c.secondary_fixed_dim })
	hl("@lsp.type.typeParameter", { fg = c.secondary_fixed_dim })
