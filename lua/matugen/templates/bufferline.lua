return function(c, hl)
	...
	hl("BufferLineModified", { fg = c.tertiary_fixed_dim, bg = c.surface_low })
	hl("BufferLineModifiedSelected", { fg = c.tertiary_fixed_dim, bg = c.surface_high })
	hl("BufferLineModifiedVisible", { fg = c.tertiary_fixed_dim, bg = c.surface_container })
