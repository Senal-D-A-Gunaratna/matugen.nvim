return function(c, hl)
  ...
  hl("iCursor", { fg = c.on_primary, bg = c.cursor_beam })
  hl("vCursor", { fg = c.on_primary, bg = c.secondary })
  hl("rCursor", { fg = c.on_primary, bg = c.cursor_underline })
  hl("oCursor", { fg = c.on_primary, bg = c.cursor_underline })
  hl("lCursor", { fg = c.on_primary, bg = c.cursor_beam })
