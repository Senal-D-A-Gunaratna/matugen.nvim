return function(c, hl)
	...
	hl("OilTypeLink", { fg = c.secondary_fixed_dim })
	hl("OilTypeSocket", { fg = c.tertiary })
	hl("OilTypeFifo", { fg = c.tertiary })
	hl("OilTypeDevice", { fg = c.secondary_fixed_dim })
end
