return function(c, hl)
	...
	hl("BlinkCmpKindClass", { fg = c.secondary_fixed_dim })
	hl("BlinkCmpKindColor", { fg = c.tertiary })
	hl("BlinkCmpKindConstant", { fg = c.primary_fixed_dim })
	hl("BlinkCmpKindConstructor", { fg = c.primary })
	hl("BlinkCmpKindEnum", { fg = c.secondary_fixed_dim })
	hl("BlinkCmpKindEnumMember", { fg = c.primary_fixed_dim })
